...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/BSHelper/BSHelper.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/EKKeyboardAvoiding/EKKeyboardAvoiding.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MSSPopMasonry/MSSPopMasonry.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MagicalRecord/MagicalRecord.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Masonry/Masonry.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RDVKeyboardAvoiding/RDVKeyboardAvoiding.framework"
