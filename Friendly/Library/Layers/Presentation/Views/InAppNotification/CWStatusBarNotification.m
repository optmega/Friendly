...
@property (nonatomic, copy) CWCompletionBlock tapComplite;
...
- (void)displayNotificationWithMessage:(NSString *)message
                           ...
                           tapComplite:(CWCompletionBlock)tapComplite
{
    self.tapComplite = tapComplite;
    [self displayNotificationWithMessage:message forDuration:duration];
}
...
- (void)displayNotificationWithView:(UIView *)view forDuration:(NSTimeInterval)duration withTappedBlock:(CWCompletionBlock) tappedBlock {
    self.tapComplite = tappedBlock;
    [self displayNotificationWithView:view forDuration:duration];
}
