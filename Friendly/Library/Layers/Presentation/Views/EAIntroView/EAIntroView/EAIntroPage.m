...
#define DEFAULT_LABEL_COLOR [UIColor clearColor]
...
#define DEFAULT_TITLE_IMAGE_Y_POSITION 0
...
//    newPage.customView.translatesAutoresizingMaskIntoConstraints = NO;
    newPage.bgColor = customV.backgroundColor;//[UIColor clearColor];//customV.backgroundColor;
    return newPage;
}
